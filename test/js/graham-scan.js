...
function testGrahamScan() {
    // Examples from <a href="https://people.mpi-inf.mpg.de/~mehlhorn/ftp/classroomExamplesNonrobustness.pdf">
    // Classroom Examples of Robustness Problems in Geometric Computations</a>
    ...
    let hull = B.getBoundingHull(ps, 0);

    console.log(hull);

    z = calcZoom([hull, ps]);
    zoom(s1, z.min, z.min, z.max-z.min, z.max-z.min);
    
    hull.push(hull[0]);
    drawPolyLine(s1, hull);
    drawDots(s1, ps, 1);
}